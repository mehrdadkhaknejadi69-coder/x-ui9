...
.card{position:relative;
  width:100%;margin-top:28px;padding:28px 26px;border-radius:22px;
...
.inp input{width:100%;padding:13px 42px;border-radius:12px;border:1px solid var(--line);background:rgba(0,0,0,.28);color:var(--text);font-size:14px;outline:none;transition:.15s;font-family:inherit}
...
.btn-main{width:100%;padding:14px;border:0;border-radius:12px;background:linear-gradient(90deg,var(--accent2),var(--accent));color:#fff;font-weight:800;font-size:14.5px;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:8px;transition:.18s;box-shadow:0 14px 30px -10px rgba(168,85,247,.65)}
...
<div class="wrap">
  ...
  <div class="login-status"><span class="live"></span><span>SECURE CONTROL CENTER · ENCRYPTED SESSION</span></div>
  <div class="card">
    <div class="login-card-glow"></div>
    <div style="display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:18px"><div><div style="font-size:10px;letter-spacing:.16em;color:#8fa1c0;font-weight:800">ADMIN ACCESS</div><div style="font-size:16px;font-weight:900;margin-top:4px">ورود امن به مرکز کنترل</div></div><div style="width:38px;height:38px;border-radius:12px;display:grid;place-items:center;border:1px solid rgba(143,217,255,.18);background:rgba(62,166,255,.08);color:#8fd9ff;box-shadow:0 0 25px rgba(62,166,255,.12)"><i class="ti ti-shield-lock" style="font-size:18px"></i></div></div>
    ...
    <div class="security-strip"><span><i class="ti ti-shield-check"></i>Session Protected</span><span><i class="ti ti-lock"></i>Secure Cookie</span><span><i class="ti ti-activity"></i>Live Monitor</span></div>
  </div>
...
var I18N = {
  fa: {
    ...
    subtitle: "پلتفرم مدیریت فروش و نمایندگی VPN",
  ...
  en: {
    ...
    subtitle: "VPN sales &amp; reseller management platform",
    emailLabel: "Username",
    emailPh: "VodiAdmin",
    passLabel: "Password",
...
.inbound-board{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.inbound-card{border:1px solid var(--line);border-radius:18px;background:linear-gradient(145deg,var(--panel),rgba(124,92,255,.035));padding:15px;box-shadow:var(--shadow-sm);overflow:hidden}.inbound-card:hover{border-color:color-mix(in srgb,var(--accent) 45%,var(--line));transform:translateY(-2px);box-shadow:var(--shadow-md),var(--ui-glow)}.inbound-card.is-off{opacity:.68}.ib-top{display:flex;align-items:center;gap:11px}.ib-symbol{width:42px;height:42px;border-radius:13px;display:grid;place-items:center;background:linear-gradient(145deg,rgba(124,92,255,.2),rgba(57,214,255,.08));color:var(--accent);font-size:19px;border:1px solid rgba(124,92,255,.18)}.ib-main{min-width:0;flex:1}.ib-title-row{display:flex;align-items:center;gap:8px}.ib-title-row b{font-size:13px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ib-sub{color:var(--sub2);font-size:9px;margin-top:5px}.ib-actions{display:flex;gap:5px}.ib-tags{display:flex;flex-wrap:wrap;gap:6px;margin:14px 0}.ib-tags span{padding:5px 8px;border:1px solid var(--line);background:var(--panel2);border-radius:8px;color:var(--sub);font-size:9px}.ib-metrics{display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:7px}.ib-metrics>div{padding:9px;border-radius:11px;border:1px solid var(--line);background:rgba(255,255,255,.018);min-width:0}.ib-metrics small{display:block;color:var(--sub2);font-size:8px;margin-bottom:4px}.ib-metrics b{font-size:10px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ib-progress{height:4px;border-radius:99px;background:#20283a;overflow:hidden;margin-top:7px}.ib-progress i{display:block;height:100%;background:linear-gradient(90deg,var(--accent),#39d6ff);border-radius:99px}.ib-footer{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-top:12px;padding-top:11px;border-top:1px solid var(--line)}.ib-footer>span{font-size:9px;color:var(--sub2);max-width:42%;overflow:hidden;text-overflow:ellipsis}.ib-footer>div{display:flex;gap:5px;align-items:center}.ib-footer .btn{padding:6px 9px;font-size:9px}.ib-footer .iconbtn{width:30px;height:30px}@media(max-width:1050px){.inbound-board{grid-template-columns:1fr}.ib-metrics{grid-template-columns:1.5fr 1fr 1fr 1fr}}@media(max-width:600px){.ib-metrics{grid-template-columns:1fr 1fr}.ib-footer{align-items:flex-start;flex-direction:column}.ib-footer>span{max-width:100%}}
...
:root{--accent:#7c5cff;--accent-d:#6548e8;--glow:rgba(124,92,255,.24)}
body{background:radial-gradient(900px 500px at 75% -10%,rgba(124,92,255,.10),transparent 65%),var(--bg)}
.sidebar{width:268px;background:linear-gradient(180deg,#0d111b 0%,#0b0f17 100%);box-shadow:inset -1px 0 rgba(255,255,255,.04),20px 0 60px rgba(0,0,0,.16)}
.sidebar-brand{padding:18px 20px 17px}.sidebar-brand img{width:38px;height:38px;border-radius:12px}.sidebar-brand div{font-size:15px}.sidebar-brand small{color:#6f7b92}
.tab{padding:11px 14px;border-radius:11px;margin:2px 0}.tab.on{background:linear-gradient(135deg,#7c5cff,#5b46d6);box-shadow:0 10px 25px -10px rgba(124,92,255,.85)}
.topbar{height:68px;padding:0 26px;background:rgba(13,17,27,.88);backdrop-filter:blur(18px);box-shadow:0 1px 0 rgba(255,255,255,.025)}
...
<div id="app">
  ...
  <div class="body-wrap">
    ...
    <div class="page" id="pg-links">
      <div class="pg-head inbound-head"><div><div class="eyebrow"><span class="live-dot"></span> VODIWALKER CORE</div><h1>اینباندها</h1><p>مرکز مدیریت اینباند، ساخت کلاینت و کنترل دسترسی؛ با تجربه‌ای مدرن و سریع.</p></div>
        <div class="toolbar">
      ...
      <div class="inbound-strip">
        <div><i class="ti ti-network"></i><span><b>مدیریت یکپارچه</b><small>پروتکل، پورت، ترافیک و انقضا</small></span></div>
        <div><i class="ti ti-shield-check"></i><span><b>کنترل دسترسی</b><small>IP Limit و محدودیت اتصال</small></span></div>
        <div><i class="ti ti-chart-line"></i><span><b>مانیتورینگ زنده</b><small>مصرف و وضعیت هر کانفیگ</small></span></div><div><i class="ti ti-users"></i><span><b>Client Manager</b><small>چند کلاینت واقعی برای هر اینباند</small></span></div>
      </div>
      <div class="inbound-board" id="linksBody"></div>
    ...
    <div class="page" id="pg-settings">
      ...
      <div class="two-col">
        <div class="card settings-card">
          ...
          <div class="grp"><label>رمز فعلی</label><input type="password" id="curPass"></div><div class="row2"><div class="grp"><label>رمز جدید</label><input type="password" id="newPass"></div><div class="grp"><label>تکرار رمز جدید</label><input type="password" id="repPass"></div></div>
...
function toggleTheme(){
  const a=getAppearance(); a.theme=(a.theme==='light'?'dark':'light'); saveAppearance(a);
}
...
function renderLinks(){
  ...
  const filtered = LINKS.filter(l=>{ if(l.is_client) return false; if(cat && String(l.category_id)!==String(cat)) return false; if(q && !(`${l.label||''} ${l.uuid||''} ${l.protocol||''}`).toLowerCase().includes(q)) return false; return true; });
  ...
  $('linksBody').innerHTML = filtered.map(l=>{
    ...
    return `<article class="inbound-card ${l.active?'':'is-off'}"><div class="ib-top"><div class="ib-symbol"><i class="ti ti-network"></i></div><div class="ib-main"><div class="ib-title-row"><b>${escapeHtml(l.label||'Unnamed Inbound')}</b>${statusBadge(l)}${l.live_status==='live'?'<span class="badge green">LIVE</span>':'<span class="badge red">LINK-ONLY</span>'}</div><div class="ib-sub mono">${escapeHtml(l.uuid.slice(0,18))}…</div></div><div class="ib-actions"><button class="iconbtn" title="کلاینت‌ها" onclick="openClients('${l.uuid}')"><i class="ti ti-users"></i></button><button class="iconbtn" title="اشتراک" onclick="showSubLink('${l.uuid}')"><i class="ti ti-qrcode"></i></button><button class="iconbtn" title="ویرایش" onclick="openLinkDrawer('${l.uuid}')"><i class="ti ti-pencil"></i></button><button class="iconbtn" title="فعال/غیرفعال" onclick="toggleLink('${l.uuid}', ${!l.active})"><i class="ti ti-power"></i></button></div></div><div class="ib-tags"><span>${protoLabel(l)}</span><span class="mono">:${port}</span><span>${escapeHtml(l.category_name||'بدون دسته')}</span><span>${l.network||'tcp'} / ${l.security||'none'}</span><span>${Number(l.client_count||0)} Client</span></div><div class="ib-metrics"><div><small>مصرف</small><b>${fmtBytes(l.used_bytes||0)}${l.limit_bytes>0?' / '+fmtBytes(l.limit_bytes):' / ∞'}</b><div class="ib-progress"><i style="width:${pct}%"></i></div></div><div><small>اتصال</small><b>${Number(l.connections||0)} / ${Number(l.connection_limit||0)||'∞'}</b></div><div><small>انقضا</small><b>${l.expires_at?escapeHtml(l.expires_at.slice(0,10)):'∞'}</b></div><div><small>IP</small><b>${Number(l.ip_limit||0)||'∞'}</b></div></div><div class="ib-footer"><span class="mono">${escapeHtml(l.address||'0.0.0.0')}</span><div><button class="btn sm" onclick="openClients('${l.uuid}')"><i class="ti ti-users"></i>Clients</button><button class="btn sm" onclick="showSubLink('${l.uuid}')"><i class="ti ti-link"></i>Subscription</button><button class="btn sm primary" onclick="openLinkDrawer('${l.uuid}')"><i class="ti ti-settings"></i>Manage</button><button class="iconbtn" title="حذف" onclick="deleteLink('${l.uuid}')"><i class="ti ti-trash" style="color:var(--bad)"></i></button></div></div></article>`;
  }).join('');
}
  ...
  openDrawer(editing?'ویرایش اینباند':'اینباند جدید', `
    ...
    <div id="quickFieldsWrap" style="display:${isManual?'none':'block'}">
      <div class="ib-section"><div class="ib-section-head"><div><b>مشخصات سریع</b><small>برای ساخت کانفیگ آماده</small></div></div><div class="ib-section-body">
        <div class="ib-grid"><div class="grp"><label>نام / Remark</label><input id="fLabel" value="${escapeHtml(l.label||'')}" placeholder="مثلاً: VIP-01"></div>
        <div class="grp"><label>دسته‌بندی</label><select id="fCategory"><option value="0">بدون دسته</option>${CATEGORIES.map(c=>`<option value="${c.id}" ${String(l.category_id)===String(c.id)?'selected':''}>${escapeHtml(c.name)}</option>`).join('')}</select></div>
        ...
        <div class="grp"><label>Connection Limit</label><input id="fConnLimit" type="number" min="0" value="${l.connection_limit||0}"></div>
        <div class="grp"><label>Speed (Mbit/s)</label><input id="fSpeed" type="number" min="0" value="${l.speed_limit_bytes?Math.max(1,Math.round(l.speed_limit_bytes*8/1000000)):''}"></div>
        <div class="grp ib-full"><label>یادداشت</label><input id="fNote" value="${escapeHtml(l.note||'')}"></div></div>
      </div></div>
    </div>`,
...
async function submitLink(uid){
  ...
  const portEl=proto==='manual'?$('mPort'):$('fPort'); const port=Number(portEl?.value||443);
  if(!Number.isInteger(port)||port<1||port>65535){toast('پورت باید بین 1 تا 65535 باشد',false);return}
  const num=(id)=>Math.max(0,Number($(id)?.value||0));
  const body={label:($('fLabel')?.value||'').trim(),protocol:proto,category_id:$('fCategory')?.value||'0',limit_value:num('fLimitVal'),limit_unit:$('fLimitUnit')?.value||'GB',expires_days:num('fDays'),ip_limit:num('fIpLimit'),connection_limit:num('fConnLimit'),speed_limit_value:num('fSpeed'),speed_limit_unit:'MBIT',note:($('fNote')?.value||'').trim()};
  if(proto==='manual'){
